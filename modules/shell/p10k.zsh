...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#363a4f'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#363a4f'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#6e738d'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#cad3f5'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#363a4f'
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#a6da95'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#363a4f'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#eed49f'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#363a4f'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#a6da95'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#363a4f'
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#6e738d}'   # muted (overlay)
    local      clean='%F{#a6da95}'  # green (Catppuccin green)
    local   modified='%F{#eed49f}'  # yellow (Catppuccin yellow)
    local  untracked='%F{#8bd5ca}'  # teal (Catppuccin teal)
    local conflicted='%F{#ed8796}' # red (Catppuccin red)
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#eed49f'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#363a4f'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#8bd5ca'
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND='#363a4f'
  ...
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND='#363a4f'
  # Custom icon.
